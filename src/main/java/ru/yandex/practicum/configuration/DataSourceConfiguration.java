...
public class DataSourceConfiguration {
    @Bean
    @Profile("dev")
    public DataSource devDataSource(@Value("${spring.datasource.driver}") String driver,
    ...
    @Bean
    @Profile("test")
    public DataSource testDataSource(@Value("${test.spring.datasource.driver}") String driver,
